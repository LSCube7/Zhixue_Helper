...
(function() {
    ...
    async function getAcademicYear() {
        try {
            ...
            const response = await fetch('https://ali-bg.zhixue.com/zhixuebao/base/common/academicYear', {
                method: 'GET',
                headers: {
    ...
    async function getExamList(pageIndex = 1, academicYear = null) {
        try {
            ...
            if (!xToken) {
                console.error('❌ 未找到xToken，请确保已登录');
                alert('未找到xToken，请确保已登录');
                return null;
            }

            console.log('🔑 获取到的xToken:', xToken);
